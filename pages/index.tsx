...
import { BannerText } from '../src/components/bannerText/BannerText';
import { FilterAndText } from '../src/components/filterAndText/FilterAndText';
    ...
    <div className={styles.container}>
      ...
      {user.id ? (
        <div className={styles.navigationLink}>
          <Link href="/new">
            <div>
              <AddCircleIcon id={styles.AddbtnLarge} />
            </div>
          </Link>
        </div>
      ) : null}
